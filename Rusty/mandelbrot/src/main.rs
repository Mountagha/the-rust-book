...
/// Given the row and the column of a pixel in the output image,
...
/// plane designed the era our image covers
...
/// Render a rectange of the Mandelbrot set into a buffer of pixels.
/// The `boudns` argument gives the with and height of the buffer `pixels`,
/// which holds one grayscale pixel per byte. the `upper_left` and `lower_right`
/// arguments specif points on the complex plane corresponding to the upper.
